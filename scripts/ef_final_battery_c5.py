...
def main() -> int:
    ...
    c5 = json.loads((BENCH / "acceptance_c5_auto.json").read_text(encoding="utf-8"))
    hand = json.loads((BENCH / "acceptance_c5_hand.json").read_text(encoding="utf-8"))
    lat: list[float] = []
    import sqlite3
    ...
    (BENCH / "c5_judging_listing.json").write_text(
    ...
    out = REPO / "docs" / "evidence-fabric" / "c5_battery_phase1.json"
    ...
    print(f"[c5] phase-1 receipt -> {out}")
    return 0
