...
class NLMConfig:
    ...
    nlm_browser_profile_root: str = r"$CLAUDE_PLUGIN_ROOT/.browser\notebooklm"
...
$CLAUDE_PLUGIN_ROOT/bin\csf-source --readiness-matrix --video-ids KvC7ct1UVBs,cbfnFt9lLV4,mzKV2BoSPvs
```
