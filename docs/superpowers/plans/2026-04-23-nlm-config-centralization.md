...
Run: `PYTHONPATH=P:\packages\yt-is python -m pytest P:\packages\yt-is\tests\test_nlm_config.py -q`
...
Run: `PYTHONPATH=P:\packages\yt-is python -m pytest P:\packages\yt-is\tests\test_transcript.py -q`
...
Run: `PYTHONPATH=P:\packages\yt-is python -m pytest P:\packages\yt-is\tests\test_nlm_batch.py -q`
...
Run: `PYTHONPATH=P:\packages\yt-is python -m pytest P:\packages\yt-is\tests\test_nlm_config.py P:\packages\yt-is\tests\test_nlm_batch.py P:\packages\yt-is\tests\test_transcript.py -q`
