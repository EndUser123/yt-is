...
Run: `python -m pytest $CLAUDE_PLUGIN_ROOT/tests\test_benchmark_manifest.py -q`
...
Run: `python -m pytest $CLAUDE_PLUGIN_ROOT/tests\test_fallback_crossover_benchmark.py -k manifest -q`
